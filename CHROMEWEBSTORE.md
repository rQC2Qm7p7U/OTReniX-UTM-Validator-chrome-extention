...
|---------|------|---------|--------|
| v3.4.0 | 2026-05-31 | Integrated GDPR/CCPA Cookie Consent audit, flagging tracking cookies stored prior to consent, and added visual status indicators on Dashboard and PDF exports. | Draft |
